...
class ShProductBrand(models.Model):
    ...
    product_ids = fields.One2many("product.template", "sh_brand_id", string="Products")
    ...
    sh_product_count = fields.Integer("Products", compute="_compute_product_counts")
